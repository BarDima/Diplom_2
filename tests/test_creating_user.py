...
class TestCreateUser:
    ...
    def test_create_user(self, add_user_url, delete_user_url):
    ...
    def test_create_existing_user(self, add_user_url):
        payload = {
    ...
    def test_create_user_missing_fields(self, add_user_url):
        payload = {
            "email": "test-data@yandex.ru"
        }
        response = requests.post(add_user_url, json=payload)
